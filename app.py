...
import logging
from utils import convert_image_to_base64_and_test  # Ensure this function exists
...
app = FastAPI(
    ...
    version="1.0.0",
    description="API for detecting leaf diseases from uploaded images"
)
...
async def disease_detection_file(file: UploadFile = File(...)):
    ...
    try:
        ...
        # Process file directly from memory using utils function
